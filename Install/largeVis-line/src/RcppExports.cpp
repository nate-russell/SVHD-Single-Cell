...
// LINE
arma::mat LINE(arma::mat coords, arma::ivec& targets, const IntegerVector sources, const IntegerVector ps, const arma::vec ws, const double rho, const long nBatches, const int M, bool verbose);
RcppExport SEXP largeVis_LINE(SEXP coordsSEXP, SEXP targetsSEXP, SEXP sourcesSEXP, SEXP psSEXP, SEXP wsSEXP, SEXP rhoSEXP, SEXP nBatchesSEXP, SEXP MSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< arma::mat >::type coords(coordsSEXP);
    Rcpp::traits::input_parameter< arma::ivec& >::type targets(targetsSEXP);
    Rcpp::traits::input_parameter< const IntegerVector >::type sources(sourcesSEXP);
    Rcpp::traits::input_parameter< const IntegerVector >::type ps(psSEXP);
    Rcpp::traits::input_parameter< const arma::vec >::type ws(wsSEXP);
    Rcpp::traits::input_parameter< const double >::type rho(rhoSEXP);
    Rcpp::traits::input_parameter< const long >::type nBatches(nBatchesSEXP);
    Rcpp::traits::input_parameter< const int >::type M(MSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    __result = Rcpp::wrap(LINE(coords, targets, sources, ps, ws, rho, nBatches, M, verbose));
    return __result;
END_RCPP
}
